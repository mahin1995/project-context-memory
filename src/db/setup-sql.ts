export const SETUP_SQL_TEMPLATE = `
...
export function renderSetupSql(schemaName: string, embeddingDimensions: number): string {
  return SETUP_SQL_TEMPLATE.replaceAll("{{schema_name}}", schemaName).replaceAll(
